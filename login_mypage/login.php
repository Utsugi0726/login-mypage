...
<header>
    ...
    <div class="login"><a href="http://localhost/login_mypage/login_mypage/login.php">ログイン</a></div>
</header>
    ...
    <form action="mypage.php" method="post">
     <div class="form_contents">
        ...
        <div class="password">
            ...
            <input type="password" class="formbox" size="40" value="<?php if(isset($_COOKIE['login_keep'])){echo $_COOKIE['password'];}
             ?>" name="password" >
        </div>
